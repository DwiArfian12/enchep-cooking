<template>
  <div v-if="!iAmLoggedIn" class="auth">
  ...
  <div v-else class="">
    <div class="dropdown text-end" @click="toggleMenu">
      ...
      <ul class="dropdown-menu text-small" :class="showMenu ? 'show' : ''">
        <li>
          <NuxtLink class="dropdown-item" to="/iam/dashboard">Dashboard</NuxtLink>
        </li>
        <li>
          <NuxtLink class="dropdown-item" to="/iam/dashboard/profile">Profile</NuxtLink>
        </li>
        <li>
          <NuxtLink class="dropdown-item" to="/iam/dashboard/settings">Settings</NuxtLink>
        </li>
        <li>
